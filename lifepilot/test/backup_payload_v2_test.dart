...
void main() {
  group('BackupPayloadV2 Serialization & Edge Cases', () {
    ...
    test('fromJson parses empty arrays and handles missing settings gracefully', () {
      ...
      expect(payload.settings.currency, 'LKR'); // Default currency code fallback
      expect(payload.settings.themeMode, isNull);
    });

    test('BackupSettingsV2 fromJson handles null/missing fields gracefully', () {
    ...
    test('BackupEventV2 fromJson applies fallback defaults on missing keys', () {
    ...
    test('BackupCategoryV2 fromJson applies fallback defaults on missing keys', () {
    ...
    test('BackupAccountV2 fromJson applies fallback defaults on missing keys', () {
    ...
    test('BackupTransactionV2 fromJson applies fallback defaults on missing keys', () {
