...
void main() {
  ...
  testWidgets('Restore workflow - entering valid password reveals summary dialog',
    ...
    final passwordField = find.widgetWithText(TextFormField, 'Backup password');
  ...
  testWidgets('Restore workflow - tapping Cancel on summary dialog aborts restore with zero database apply calls',
      (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(800, 1200));
    ...
    await tester.enterText(find.widgetWithText(TextFormField, 'Backup password'), 'pass');
  ...
  testWidgets('Restore workflow - tapping Confirm (Replace Data) applies import and shows SnackBar',
      (WidgetTester tester) async {
    await tester.binding.setSurfaceSize(const Size(800, 1200));
